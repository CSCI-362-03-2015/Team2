// @(#) EnDeFunc.js 3.7 ; generated by EnDe2js.pl 3.18  from: aes.js 3.7 12/06/16 09:58:42
/*
...
// @(#) EnDeFunc.js 3.2 ; generated by EnDe2js.pl 3.18  from: blowfish.js 3.2 12/06/16 09:49:43
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 3.2 ; generated by EnDe2js.pl 3.18  from: des.js 3.2 12/06/17 19:17:52
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
EnDe.Func.DES   = new function() {
	this.SID    = '3.2';
	this.list   = {
 	encrypt:	[EnDe.DES.encrypt	(key,	 src,	 cbc,	 iv,	 pad),	'wrapper for des() encryption; returns binary data'],
	decrypt:	[EnDe.DES.decrypt	(key,	 src,	 cbc,	 iv,	 pad),	'wrapper for des() decryption; returns binary data'],

  EN: {
		des    :	[EnDe.DES.EN.des	(key,	 src,	 cbc,	 iv,	 pad),	'wrapper for des() encryption; returns binary data'],
	'dumm':'dumm'},

  DE: {
		des    :	[EnDe.DES.DE.des	(key,	 src,	 cbc,	 iv,	 pad),	'wrapper for des() decryption; returns binary data'],
	'dumm':'dumm'},
	'dumm':'dumm'},
  desc: '23'
	}; // .list
};
// @(#) EnDeFunc.js 3.5 ; generated by EnDe2js.pl 3.18  from: crc.js 3.5 12/06/02 17:33:14
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 3.3 ; generated by EnDe2js.pl 3.18  from: md4.js 3.3 11/12/30 19:19:20
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 3.3 ; generated by EnDe2js.pl 3.18  from: md5.js 3.3 11/12/30 19:13:53
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 3.3 ; generated by EnDe2js.pl 3.18  from: rmd.js 3.3 11/12/30 19:14:51
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 3.6 ; generated by EnDe2js.pl 3.18  from: sha.js 3.6 12/06/03 12:22:20
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 3.3 ; generated by EnDe2js.pl 3.18  from: sha512.js 3.3 11/12/30 19:12:03
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 3.1 ; generated by EnDe2js.pl 3.18  from: EnDeB64.js 3.1 12/06/05 00:02:10
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 3.1 ; generated by EnDe2js.pl 3.18  from: EnDeIP.js 3.1 12/06/04 21:21:51
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 3.1 ; generated by EnDe2js.pl 3.18  from: EnDeTS.js 3.1 12/06/04 21:51:41
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 1.7 ; generated by EnDe2js.pl 3.18  from: EnDeHTTP.js 1.7 12/05/29 22:13:54
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
// @(#) EnDeFunc.js 3.36 ; generated by EnDe2js.pl 3.18  from: EnDe.js 3.36 12/06/17 19:21:55
/*
 * parameters named _n1_, _n2_, .. _n7_ are unused parameters for that function
 */
if (typeof(EnDe)==='undefined') { EnDe = new function() {}; }
...
c2h    :	[EnDe.c2h	(src),	'convert (Unicode) characters to hex value (string)'],
...
h2n    :	[EnDe.h2n	('nibble2',	mode,	upper,	src,	prefix,	suffix,	delim),	'nibble2: convert hex value to its second nibble hex value'],
  ...
  EN: {
    ...
    des      :	[EnDe.EN.des	(type,	mode,	upper,	src,	iv,	key,	_n7_),	'wrapper for des(); (single) DES and tripple DES encryption in ECB or CBC mode'],
    des      :	[EnDe.EN.des	('desECBn',	mode,	upper,	src,	iv,	key,	_n7_),	'desECBn: ECB mode, message (src) padded with 0-bytes'],
    des      :	[EnDe.EN.des	('desECBp',	mode,	upper,	src,	iv,	key,	_n7_),	'desECBp: ECB mode, message (src) padded with PKCS7'],
    des      :	[EnDe.EN.des	('desECBs',	mode,	upper,	src,	iv,	key,	_n7_),	'desECBs: ECB mode, message (src) padded with spaces'],
    des      :	[EnDe.EN.des	('desECB_',	mode,	upper,	src,	iv,	key,	_n7_),	'desECB_: ECB mode, message (src) without padding'],
    des      :	[EnDe.EN.des	('desCBCn',	mode,	upper,	src,	iv,	key,	_n7_),	'desCBCn: CBC mode, message (src) padded with 0-bytes'],
    des      :	[EnDe.EN.des	('desCBCp',	mode,	upper,	src,	iv,	key,	_n7_),	'desCBCp: CBC mode, message (src) padded with PKCS7'],
    des      :	[EnDe.EN.des	('desCBCs',	mode,	upper,	src,	iv,	key,	_n7_),	'desCBCs: CBC mode, message (src) padded with spaces'],
    des      :	[EnDe.EN.des	('desCBC_',	mode,	upper,	src,	iv,	key,	_n7_),	'desCBC_: CBC mode, message (src) without padding'],
  ...
  DE: {
    ...
    des      :	[EnDe.DE.des	(type,	mode,	upper,	src,	iv,	key,	delim),	'wrapper for des(); (single) DES and tripple DES decryption in ECB or CBC mode'],
